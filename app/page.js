                ...
                <div className="col-md-5">
                  <div className="home-banner-photo">
                    {homeAcf.home_banner_photo &&
                      <Image className="att_photo" src={homeAcf.home_banner_photo?.url} alt={homeAcf.home_banner_photo?.alt} width={homeAcf.home_banner_photo?.width} height={homeAcf.home_banner_photo?.height} title={homeAcf.home_banner_photo?.title} loading="eager" />
                    }
