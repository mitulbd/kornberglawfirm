// app/components/FooterClient.js
"use client";
  ...
  return (
    <>
      {pathname !== '/web-stories/understanding-car-accidents-lessons-responses-and-representation/' && (
        <>
          {pathname !== '/' && pathname !== '/contact' && pathname !== '/endorsement' && (
                  ...
                  <div className="col-xxl-10">
                    <div className="social-list">
                      {options.social_link_list.map((data, index) => (
                        <Link key={index} href={data.social_link} target="_blank" rel="nofollow noopener noreferrer" className="social-block" title={data.social_title} aria-label={data.social_title}>
                          <Image src={data.social_image?.url} alt={data.social_title} title={data.img_title} width={data.social_image?.width} height={data.social_image?.height} />
                          {data.social_title}
                        </Link>
                      ))}
                    </div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-sm-6">
                              <div className="mapiframe">
                                <GoogleMapsEmbed height={140} width="100%" src={data.office_map_iframe} />
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div className="container">
              <div className="footer-bottom-row">
                <div className="footer-bottom-col footer-bottom-left">
                  <span className="copy-text">© {currentYear} Law Offices of Howard Kornberg</span><span>|</span>
          ...
          {options.iconPhone && options.phone_no &&
            <Link className="mobile-call" href={`tel:${options.phone_no}`} aria-label="Mobile call">
              <Image src={options.iconPhone} alt="Phone" title="Phone" width={38} height={38} />
            </Link>
          }
